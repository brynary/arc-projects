...
- Pre-race flow (HTML overlays on the canvas):
  - Track selection screen (2 tracks with name, description)
  - Character selection (4 characters with stat bars)
  - Difficulty picker: Chill / Standard / Mean
  - Mirror Mode toggle
  - Allow Clones toggle
  - Start Race button
- In-race HUD (HTML overlay):
  - Position indicator (1st-4th with ordinal suffix)
...
- Visual polish:
  ...
  - Skybox per track theme (2 skyboxes)
...
Ensure both tracks from the spec are fully implemented with 4 characters.
