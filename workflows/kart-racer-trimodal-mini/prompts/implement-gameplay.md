...
- Position-weighted random distribution:
  - 1st place: mostly defensive items (shield)
  - 2nd place: balanced mix
  - 3rd-4th place: mostly offensive items
- Implement all 3 items from the spec with their effects
...
- 3 CPU karts on track simultaneously
...
- Race position tracking for all 4 racers
